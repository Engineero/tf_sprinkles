...
version_dict = {}
version_path = convert_path('sprinkles/_version.py')
...
CLASSIFIERS = ['Development Status :: 5 - Production/Stable',
               ...
               'Topic :: Utilities']
PROJECT_URLS = {'Documentation': 'https://engineero.github.io/sprinkles',
                'Source': 'https://github.com/Engineero/sprinkles',
                'Tracker': 'https://github.com/Engineero/sprinkles/issues'}
...
setup(name='sprinkles',
      ...
      url='https://github.com/Engineero/sprinkles',
